\documentclass[a4paper,unpublished,onecolumn,nopdfoutputerror]{quantumarticle}
...
generation scripts) used in this study are available with the manuscript
submission as arXiv ancillary files, and on request from the author. All
experiments are reproducible with NumPy, SciPy, scikit-learn, and matplotlib
only.
